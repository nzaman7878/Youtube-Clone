  ...
  return (
    <div className="grid grid-flow-col p-5 m-2 shadow-lg">
        ...
        <div  className="col-span-10 px-10">
            <input className="border w-1/2 border-gray-400 p-2 rounded-l-full" 
             type="text" />
